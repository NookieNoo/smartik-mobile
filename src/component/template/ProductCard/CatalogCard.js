...
const CatalogCard = ({ product, price, ...props }) => {
  ...
  return (
    <Wrapper>
      <Button onPress={() => navigation.push('ProductScreen', { uuid: product.uuid })}>
        <Image
          resizeMode={'contain'}
        ...
        <InfoView>
          ...
          <Expire>
            <ExpireDate numberOfLines={1}>
              Годен до {dayjs(product.prices[0].expired_at).format('D MMMM')}
            </ExpireDate>
          </Expire>
          <Prices>
          ...
          <CardButtonWrapper>
            {cart ? (
              <>
                ...
                >
                  <ProductMinusIcon
                    color={disableMinus ? 'transparent' : '#FFFFFF'}
                    widthSize="15"
                  />
                </CartButtonInc>
                <CartCountWrapper>
                ...
                <CartButtonInc
                  ...
                  opacity={disablePlus}
                >
                  <ProductPlusIcon color={disablePlus ? 'transparent' : '#FFFFFF'} size="14" />
                </CartButtonInc>
              </>
            ) : (
              <CartButton
